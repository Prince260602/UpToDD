...
function ParentingStories() {
  ...
  const storyTitles = [
    "Parenting Stories – Share Your Parenting Journey",
    "UpTodd Partners with MOM Influencer Asha Solanki",
    "Parenting Story of POOJA: A Mom’s Morning Magic",
    "UpTodd Partners with MOM Influencer Swapnil",
  ];
  const title = storyTitles[currentDiv - 1];
  // Ensure this effect is triggered whenever the article title changes
  ...
  const prevIndex = currentDiv > 1 ? currentDiv - 1 : totalDivs;
  const nextIndex = currentDiv < totalDivs ? currentDiv + 1 : 1;
